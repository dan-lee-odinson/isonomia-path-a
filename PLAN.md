...
1. [Path A Simulation Plan v0.1.2](docs/ISONOMIA_PathA_Simulation_Plan_v0.1.2.md) — primary build spec (modules, agents, sweep, scenarios, outputs).
2. [Tier-1 Launch Spec v0.3.4](docs/ISONOMIA_Tier1_Launch_Spec_v0.3.4.md) — contract-level rules; §7 credit/fees, §8 parameter registry, §9 activation integrity, §13 implementation clarifications. Its Conflict Register governs where the whitepaper differs. (Built against v0.2.2; §10 was updated through v0.3 → v0.3.3 to codify this repo's v3 kill-criterion finding and its control taxonomy — see DECISIONS #28, #35.)
3. [Whitepaper v0.6.3](docs/ISONOMIA_Whitepaper_v0.6.3.md) — design rationale. (Built against v0.3; the v0.4→v0.6.2 additions are governance/legal/naming doctrine — author/DOI/citation front matter, §9.6 harm-tier and §9.8 principal-verification doctrine — with no Tier-1 mechanism impact.)
